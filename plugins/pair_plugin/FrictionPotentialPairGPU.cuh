...
/*! \file FrictionPotentialPairGPU.cuh
    \brief Defines templated GPU kernel code for calculating the frictional ptl pair forces and
   torques
*/

#ifndef __FRICTION_POTENTIAL_PAIR_GPU_CUH__
#define __FRICTION_POTENTIAL_PAIR_GPU_CUH__
...
//! Kernel driver that computes lj forces on the GPU for FrictionPotentialPairGPU
/*! \param pair_args Other arguments to pass onto the kernel
    \param d_params Parameters for the potential, stored per type pair
...
#endif // __FRICTION_POTENTIAL_PAIR_GPU_CUH__
