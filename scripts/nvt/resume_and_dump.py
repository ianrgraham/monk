...
parser = argparse.ArgumentParser(
    description="Resuming from a prior simulation, \
    run an NVT ensemble")
...
parser.add_argument("--ifile-index",
                    type=int,
                    default=-1,
                    help="Index from which to start the simulation")
parser.add_argument(
    "--pair",
    nargs="+",
...
parser.add_argument("--rand-veloc",
                    action="store_true",
