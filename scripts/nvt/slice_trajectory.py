...
parser = argparse.ArgumentParser(description="Slice a hoomd trajectory and store \
...
parser.add_argument("--slice", nargs="+", type=optional_int, help="Subslice to apply to the input trajectory.", default=[None])
